<template>
<div class="dabg">
  <img class="loadchecker" @load="launch" src="https://images.wallpaperscraft.com/image/bird_silhouette_vector_134154_1920x1080.jpg" alt="ALT TEXT" />
  <figure class="snip1554" :class="{active: launchedSite}">
    <img @load="launch" src="https://images.wallpaperscraft.com/image/bird_silhouette_vector_134154_1920x1080.jpg" alt="ALT TEXT" />
...
export default {
  ...
  computed: {
    ...
    launchedSite () {
      return (this.$store.state.siteLaunched)
    }
  }
}
</script>
